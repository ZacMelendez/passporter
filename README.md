# Passporter – Local Privacy Contact Finder

Passporter is a small, fully local web app that helps you discover contact email addresses from the privacy policies of sites you have saved in your browser password manager. You can then export a CSV of those emails to start data deletion or privacy requests.
